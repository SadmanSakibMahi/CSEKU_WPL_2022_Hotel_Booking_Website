...
<head>
    ...
    <link rel="icon" href="images/about/logo.png" type="image/png">
...
<body class="bg-light">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="carousel-caption trickcenter">
                                <div class="banner_content text-center">
                                    <h2>Welcome To The Grand Placid</h2>
                                    <h6>Sense of Luxury</h6>
                                </div>
                            </div>
                        </div>
                    data;
    ...
    <div class="container availability-form">
        <div class="row">
            <div class="col-lg-12 bg-white shadow p-4 rounded">
                <h5 class="mb-4">BOOK YOUR ROOM</h5>
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="form-select shadow-none" name="adult">
                                ...
                                for ($i = 1; $i <= $guests_res['max_adult']; $i++) {
                                    echo "<option option value='$i'>$i</option>";
                                }
                                ?>
                            </select>
                        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            while ($room_data = mysqli_fetch_assoc($room_res)) {
                ...
                // shutdown on (no book now option)
                $book_btn = "";
                        ...
                        <div class="col-lg-4 col-md-6 my-3">
                            <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="mb-4">BDT rate $room_data[price] per night.</h6>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            <?php
            // $res = selectAll('facilities'); For all facilities
            $res = mysqli_query($con, "SELECT * FROM `facilities` ORDER BY `id` DESC LIMIT 5"); // For newest 5 facilities
